...
class Game:
    ...
    def __init__(self, width: int, height: int):
        ...
        self.schet: int = 0
        # self.stone: int = self.generate_stone()
    ...
    def run(self):
        while self.game.run:
            ...
            if self.game.game_over:
                ...
                if event.name in (Event.KEYDOWN, Event.UP, Event.DOWN, Event.LEFT):
                    self.game.restart()

            self.render_manager.draw_score(str(self.game.schet))
