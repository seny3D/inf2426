...
class DoubleLinkedList[T: Any]:
    ...
    def _cmp(self, other: Self) -> int:
        ...
        :param other: Self
        :return: число -1 или 0 или 1
        """
        cur_self: ListNode[T] = self._head
        cur_other: ListNode[T] = other._head
    ...
    def slow_sort(self) -> None:
        ...
        :return: None
        """
        cur1: ListNode[T] = self._head # элемент для нужного количества проходов по списку. когда достигнет конца списка, сортировка завершится
        while cur1 is not None:
            cur2: ListNode[T] = self._head # берем начальный элемент двусвязного списка
